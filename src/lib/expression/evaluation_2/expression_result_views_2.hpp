 ...
 */
template <typename T>
class ExpressionResultNullableSeries2 {
 public:
  using Type = T;

  ExpressionResultNullableSeries2(const std::vector<T>& values, const std::vector<bool>& nulls)
 ...
 */
template <typename T>
class ExpressionResultNonNullSeries2 {
 public:
  using Type = T;

  explicit ExpressionResultNonNullSeries2(const std::vector<T>& values) : _values(values) {}
 ...
 */
template <typename T>
class ExpressionResultLiteral2 {
 public:
  using Type = T;

  ExpressionResultLiteral2(const T& value, const bool null) : _value(value), _null(null) {}
