...
set_target_properties(libpqxx::pqxx_shared PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libpqxx.dylib"
  IMPORTED_SONAME_DEBUG "@rpath/libpqxx.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS libpqxx::pqxx_shared )
list(APPEND _IMPORT_CHECK_FILES_FOR_libpqxx::pqxx_shared "${_IMPORT_PREFIX}/lib/libpqxx.dylib" )
